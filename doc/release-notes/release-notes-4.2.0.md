...
### Community Fund - Accumulation of coins, signaled by version bit 7:
  ...
  - Inclusion of an additional output in the Coinstake transaction contributing 0.25KBYTE to the Community Fund
...
- Accepts URI to sign messages.
    - URIs of the format kazubyte:http://domain/something/?a=kazubyte_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- kazubyte-tx tool has been updated to use kazubyte’s own transaction structure
