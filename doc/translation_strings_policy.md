...
This document provides guidelines for internationalization of the KazuByte Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kazubyte_en.ts` remains unchanged.
