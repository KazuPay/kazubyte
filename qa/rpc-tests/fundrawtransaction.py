...
class RawTransactionsTest(KazuByteTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kazubyte address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kazubyte address" in e.error['message'])
