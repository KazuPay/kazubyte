...
class WalletTest (KazuByteTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 KBYTE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 KBYTE with subtract fee from amount
        ...
        # Sendmany 10 KBYTE with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/kazubyte/kazubyte/issues/7463
        #     # '-salvagewallet',
        # ]
