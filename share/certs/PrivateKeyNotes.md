...
unlocked to sign the KazuByte-Qt.app bundle.
...
allowing somebody to distribute a KazuByte-Qt.app or kazubyte-qt-setup.exe with a valid
...
that the kazubyte-qt.exe file inside the installer had not been tampered with.
