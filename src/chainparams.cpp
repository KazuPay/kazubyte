...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey.clear();
    txNew.strDZeel = "KazuByte genesis block";
...
{
    const char* pszTimestamp = "McCabe: 'It's possible' Trump is a Russian asset";
    const CScript genesisOutputScript = CScript() << ParseHex("04ef5102f13e2b2781b839ea78a1ed1cb90d8fc17dcc67028e92e65223ea73f8bc8d8e4d1191f37a20ad20f326912ce6e1c2e7469251a106d2a3fd55e26262d6df") << OP_CHECKSIG;
...
{
    const char* pszTimestamp = "JPMorgan's move into crypto puts the rest of the industry on notice";
    const CScript genesisOutputScript = CScript() << ParseHex("042d3e41ddb8ea3148cfdb5407383241fc0223585b25ed55deb659c0bde1a49cbc79d4ac1210d38a4766f6bb68431b773a6d5347955135502726b0743948cee36d1") << OP_CHECKSIG;
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, nVersion, genesisReward);
}
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x00007e03743973e5aef00173134b0119414750e08452973a15840d6667b65bc0"); // Add genesis here
        ...
        genesis = CreateGenesisBlock(1550633627, 246237, 0x1f00ffff, 1, 0); // update nonce - 2nd value

	    consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x00007e03743973e5aef00173134b0119414750e08452973a15840d6667b65bc0")); // todo change
        assert(genesis.hashMerkleRoot == uint256S("0x55d036e3dd66569fdd9d8b0bd5de41ce0cc19fe45238241bf13e9f459e67c2e5")); // updated
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xC3)(0xB8).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xC9)(0xE2).convert_to_container<std::vector<unsigned char> >();

        vSeeds.push_back(CDNSSeedData("byteseed.kazuexplore.com", "byteseed2.kazuexplore.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x00007e03743973e5aef00173134b0119414750e08452973a15840d6667b65bc0")),
            1550633627, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        consensus.nMajorityWindow = 1000;
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x00001dbcb813b856555cdaf52737e88b54aaaac5c6b779f23689164f3c91469b"); // put testnet genesis here
        consensus.powLimit = ArithToUint256(~arith_uint256(0) >> 16);
        consensus.nPowTargetTimespan = 30;
        consensus.nPowTargetSpacing = 30;
        consensus.fPowAllowMinDifficultyBlocks = false;
        ...
        uint32_t nTimestamp = 1550633628;
        uint256 hashGenesisBlock = uint256S("0x00001dbcb813b856555cdaf52737e88b54aaaac5c6b779f23689164f3c91469b"); // todo - update
        uint256 hashMerkleRoot = uint256S("0x116ba324fb876a8388f9c20c76db8f9d9617b1b402babb73546a0587153f6f4e"); // todo generate/update
        uint32_t nNonce = 493510; //update
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0,     hashGenesisBlock),
            1550633628, // * UNIX timestamp of last checkpoint block
            0,          // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            7000         // * estimated number of transactions per day after checkpoint
        };
...
public:
    CDevNetParams() {
        ...
        consensus.nMajorityWindow = 1000;
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x0000818cbdf05080b2209993d875082ca34acf97c3945e3f8b403ae937052773");
        consensus.powLimit = ArithToUint256(~arith_uint256(0) >> 16);
        consensus.nPowTargetTimespan = 30;
        consensus.nPowTargetSpacing = 30;
        consensus.fPowAllowMinDifficultyBlocks = false;
        ...
        uint32_t nTimestamp = 1550633629;
        // 2) Rebuild
        // 3) Launch daemon. It'll calculate the new parameters.
        // 4) Update the following variables with the new values:
        uint256 hashGenesisBlock = uint256S("0x0000818cbdf05080b2209993d875082ca34acf97c3945e3f8b403ae937052773");
        uint256 hashMerkleRoot = uint256S("0x5ce9d15338cb29b14c482bac16530f6cb77e9499028fbd292280e8ed0789da64");
        uint32_t nNonce = 2043295702;
        // 5) Rebuild. Launch daemon.
        // 6) Generate first block using RPC command "./kazubyte-cli generate 1"
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0,     hashGenesisBlock),
            1550633629, // * UNIX timestamp of last checkpoint block
            0,          // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            7000         // * estimated number of transactions per day after checkpoint
        };
...
public:
    CRegTestParams() {
        ...
        vSeeds.push_back(CDNSSeedData("testkazubyte.org", "testseed.kazubyte.org"));
