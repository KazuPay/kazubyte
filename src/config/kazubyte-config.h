/* src/config/kazubyte-config.h.  Generated from kazubyte-config.h.in by configure.  */
/* src/config/kazubyte-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KBYTECOIN_CONFIG_H

#define KBYTECOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The KazuByte Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "KazuByte Core"
...
#define PACKAGE_BUGREPORT "https://github.com/kazucoin/kazubyte/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "KazuByte Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KazuByte Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kazubyte"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.kazucoin.io/"
