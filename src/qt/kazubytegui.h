...
#ifndef KBYTECOIN_QT_KBYTECOINGUI_H
#define KBYTECOIN_QT_KBYTECOINGUI_H
...
/**
  KazuByte GUI main class. This class represents the main window of the KazuByte UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KazuByteGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KazuByteGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~KazuByteGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kazubyte wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // KBYTECOIN_QT_KBYTECOINGUI_H
