...
#ifndef KBYTECOIN_QT_KBYTECOINUNITS_H
#define KBYTECOIN_QT_KBYTECOINUNITS_H
...
/** KazuByte unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KazuByteUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KazuByteUnits(QObject *parent);

    /** KazuByte units.
      @note Source: https://en.kazubyte.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KBYTE,
...
typedef KazuByteUnits::Unit KazuByteUnit;

#endif // KBYTECOIN_QT_KBYTECOINUNITS_H
