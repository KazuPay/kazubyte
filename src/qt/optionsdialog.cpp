    ...
    mapper(0)
{
    ...
    ui->kazubyteAtStartup->setToolTip(ui->kazubyteAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->kazubyteAtStartup->setText(ui->kazubyteAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new KazuByteUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kazubyteAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKazuByteConfButton_clicked()
{
