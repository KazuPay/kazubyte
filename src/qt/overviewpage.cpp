...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(KazuByteUnits::KBYTE),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = KazuByteUnits::formatWithUnit(unit, amount, true, KazuByteUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KazuByteUnits::formatWithUnit(unit, balance, false, KazuByteUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KazuByteUnits::formatWithUnit(unit, unconfirmedBalance, false, KazuByteUnits::separatorAlways));
    ui->labelStaking->setText(KazuByteUnits::formatWithUnit(unit, stakingBalance, false, KazuByteUnits::separatorAlways));
    ui->labelImmature->setText(KazuByteUnits::formatWithUnit(unit, immatureBalance, false, KazuByteUnits::separatorAlways));
    ui->labelTotal->setText(KazuByteUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, KazuByteUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("KBYTE")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(KazuByteUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuByteUnits::separatorAlways));
    ui->label7dStakingStats->setText(KazuByteUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuByteUnits::separatorAlways));
    ui->label30dStakingStats->setText(KazuByteUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuByteUnits::separatorAlways));
    ui->label1yStakingStats->setText(KazuByteUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuByteUnits::separatorAlways));
    ui->labelallStakingStats->setText(KazuByteUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuByteUnits::separatorAlways));
}
