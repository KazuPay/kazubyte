...
#ifndef KBYTECOIN_QT_WALLETFRAME_H
#define KBYTECOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, KazuByteGUI *_gui = 0);
    ~WalletFrame();
...
#endif // KBYTECOIN_QT_WALLETFRAME_H
