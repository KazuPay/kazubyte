...
#ifndef KBYTECOIN_TEST_SCRIPTNUM10_H
#define KBYTECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KazuByte Core 0.10.0, for cross-comparison.
 */
public:
