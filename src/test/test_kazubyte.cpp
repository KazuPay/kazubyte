...
#define BOOST_TEST_MODULE KazuByte Test Suite

#include "test_kazubyte.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kazubyte_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
