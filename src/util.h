 ...
 */
#ifndef KBYTECOIN_UTIL_H
#define KBYTECOIN_UTIL_H
...
extern const char * const KBYTECOIN_CONF_FILENAME;
extern const char * const KBYTECOIN_PID_FILENAME;
...
{
    std::string s = strprintf("kazubyte-%s", name);
