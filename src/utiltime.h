...
#ifndef KBYTECOIN_UTILTIME_H
#define KBYTECOIN_UTILTIME_H
...
static std::vector<std::string> vDefaultNtpServers = {"time1.google.com", "de.pool.ntp.org",
