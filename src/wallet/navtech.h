...
#ifndef KBYTECOIN_WALLET_KBYTETECH_H
#define KBYTECOIN_WALLET_KBYTETECH_H
...
#define KBYTETECH_DEFAULT_INPUT_DELAY 1
#define KBYTETECH_DEFAULT_OUT_DELAY 10
#define KBYTETECH_DEFAULT_ENTROPY 4
...
#endif //KBYTECOIN_WALLET_KBYTETECH_H
