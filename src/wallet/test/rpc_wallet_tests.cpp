...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CKazuByteAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CKazuByteAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CKazuByteAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CKazuByteAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CKazuByteAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CKazuByteAddress(arr[0].get_str()).Get() == demoAddress.Get());
